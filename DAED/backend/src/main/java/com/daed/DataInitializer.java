...
import com.daed.model.*;
import com.daed.repository.*;
    ...
    @Override
            public void run(String... args) throws Exception {
                ...
                if (student != null && marksRepository.findByStudentId(student.getId()).isEmpty()) {
                                createMarks(student, sub1, 38, 52);
                                createMarks(student, sub2, 32, 43);
                                createMarks(student, sub3, 28, 37);
                                createMarks(student, sub4, 35, 47);
                ...
                if (student != null && attendanceRepository.findByStudentId(student.getId()).isEmpty()) {
                                createAttendance(student, sub1, 50, 45);
                                createAttendance(student, sub2, 50, 42);
                                createAttendance(student, sub3, 50, 38);
                                createAttendance(student, sub4, 50, 47);
